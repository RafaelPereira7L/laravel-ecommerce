    ...
    <header class="text-gray-600">
        <div class="container mx-auto flex justify-between items-center p-5 items-center">
            ...
            <div class="flex items-center">
                ...
                <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base md:mt-0 cursor-pointer">Admin
    ...
    <footer class="text-gray-600">
        ...
        <div class="bg-gray-100">
            <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                ...
                <span class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">Feito com 💜 por RafaelDev</span>
            </div>
        </div>
    </footer>
</body>
